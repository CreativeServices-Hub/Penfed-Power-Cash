...
lib.ssMetadata = [
		{name:"300x250_atlas_1", frames: [[164,646,60,16],[0,646,162,43],[0,0,300,250],[0,504,300,140],[0,252,300,250]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(86,79.5,1,1,0,0,0,81,21.5);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:94,alpha:1},29,cjs.Ease.get(1)).wait(211));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleX:1.0392,scaleY:1.0392,x:150.05,y:125.05},239).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(144.2,120.2,161.7,152.8);
// library properties:
lib.properties = {
