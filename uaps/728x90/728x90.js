...
lib.ssMetadata = [
		{name:"728x90_atlas_1", frames: [[0,0,728,90],[301,184,91,25],[0,184,299,20],[0,92,728,90]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,299,20);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(168.5,106,1,1,0,0,0,45.5,12.5);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(44).to({_off:false},0).to({y:60.5},15,cjs.Ease.get(1)).wait(182));

	// Layer_3
	this.instance_2 = new lib.Symbol23("synched",0);
	this.instance_2.setTransform(163,27,1,1,0,0,0,149.5,10);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:169.5,alpha:1},29,cjs.Ease.get(1)).wait(212));
...
p.nominalBounds = new cjs.Rectangle(364,45,364,73.5);
// library properties:
lib.properties = {
