...
lib.ssMetadata = [
		{name:"1280x418_atlas_1", frames: [[1223,420,205,55],[883,840,423,109],[0,420,1221,418],[0,0,1280,418],[0,840,881,418]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,881,418);
...
p.nominalBounds = new cjs.Rectangle(0,0,1221,418);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(394.5,462,1,1,0,0,0,102.5,27.5);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(44).to({_off:false},0).to({y:322.5},15,cjs.Ease.get(1)).wait(181));

	// Layer_3
	this.instance_2 = new lib.Symbol40("synched",0);
	this.instance_2.setTransform(253,116.5,1,1,0,0,0,211.5,54.5);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:268.5,alpha:1},29,cjs.Ease.get(1)).wait(211));

	// Layer_7
	this.instance_3 = new lib.Symbol44("synched",0);
	this.instance_3.setTransform(669.5,209,1,1,0,0,0,610.5,209);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(240));

	// Layer_10
	this.instance_4 = new lib.Symbol46("synched",0);
	this.instance_4.setTransform(440.5,209,1,1,0,0,0,440.5,209);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regY:208.9,scaleX:1.0597,scaleY:1.0597,y:208.9},239).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(613.7,196.5,666.3,293);
// library properties:
lib.properties = {
