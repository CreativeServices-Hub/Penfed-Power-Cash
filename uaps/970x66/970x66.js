...
lib.ssMetadata = [
		{name:"970x66_atlas_1", frames: [[0,0,970,66],[267,136,80,22],[0,136,265,17],[0,68,970,66]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,265,17);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(156,83,1,1,0,0,0,40,11);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(44).to({_off:false},0).to({y:47},15,cjs.Ease.get(1)).wait(181));

	// Layer_4
	this.instance_2 = new lib.Symbol23("synched",0);
	this.instance_2.setTransform(146.5,16.5,1,1,0,0,0,132.5,8.5);
	...
	this.instance_3.setTransform(485,33,1,1,0,0,0,485,33);
...
p.nominalBounds = new cjs.Rectangle(485,33,485,61);
// library properties:
lib.properties = {
